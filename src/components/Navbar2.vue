  ...
  <navbar-collapse>
    ...
    <navbar-item v-if="!isLoggedIn"><router-link to="/register">Register</router-link></navbar-item>
      <dropdown v-if="isLoggedIn" tag="li" class="nav-item dropdown-custom symbol-custom">
        ...
        <dropdown-menu right>
          <dropdown-item v-if="$route.meta.requiresVet"><router-link to="/home_vet">My Home</router-link></dropdown-item>
          <dropdown-item v-if="$route.meta.requiresVet"><router-link to="/medic">My Pet Record</router-link></dropdown-item>
          <dropdown-item v-if="$route.meta.requiresOwner"><router-link to="/home_owner">My Home</router-link></dropdown-item>
          <dropdown-item v-if="$route.meta.requiresOwner"><router-link to="/medic">My Pet Record</router-link></dropdown-item>

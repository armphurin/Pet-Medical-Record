                        ...
                        <row>
                            <column>
                                <div class="label-group" v-if="!password_change">
                                    ...
                                    <input class="form-control form-control-lg" type="text" placeholder="Medical License" id="vetid" v-model="vetid" style="width:100%;margin: 0 auto;border-radius: 13px;">
                                </div>
                                    <div class="label-group" v-if="password_change">
                                        <label for="lineid">Medical License</label>
                                        <input class="form-control form-control-lg" type="text" placeholder="Medical License" id="vetid" v-model="vetid" style="width:100%;margin: 0 auto;border-radius: 13px;" disabled>
                                </div>
                            </column>
                            <column>
                                <div class="label-group" v-if="!password_change">
        ...
        deletePet() {
            ...
            swal({
                ...
                if (result.value) {
                    ...
                    if (this.show_pet[0].imagePet) {
                        var imagepet = storageRef.child(
                            this.email +
                            "/" +
                            this.email +
                            "_" +
                            this.show_pet[0].name +
                            "/pets"
                        );
                        db.collection("users")
                            .doc(this.email)
            ...
            if (checkInput) {
                ...
                if (this.addImagePet) {
                    if (this.pet_type == "cat") {
                        storage
                            .ref(
                                this.email + "/" + this.email + "_" + this.pet_name + "/pets"
                            )
                            .put(this.addImagePet[0])
                            .then(user => {
                                storageRef
                                    .child(
                                        this.email +
